...
SQLAlchemy's pooling::
    ...
    engine = create_engine("oracle://", creator=pool.acquire, poolclassName=NullPool)
...
This can be achieved by wrapping ``pool.acquire()``::
    ...
    def creator():
        return pool.acquire(cclassName="MYCLASS", purity=cx_Oracle.ATTR_PURITY_SELF)

    engine = create_engine("oracle://", creator=creator, poolclassName=NullPool)
