...
Collection classes can be specified in ``relationship(collection_className=)`` as
...
def prepare_instrumentation(factory):
    ...
    This function is responsible for converting collection_className=list
    into the run-time behavior of collection_className=InstrumentedList.
